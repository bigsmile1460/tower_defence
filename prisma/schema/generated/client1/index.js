...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\user\\Desktop\\TowerDefence\\prisma\\schema\\generated\\client1",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\user\\Desktop\\TowerDefence\\prisma\\schema\\schemaAsset.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../../../.env",
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "prisma/schema/generated/client1",
    "schema/generated/client1",
  ]
...
path.join(process.cwd(), "prisma/schema/generated/client1/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/schema/generated/client1/schema.prisma")
